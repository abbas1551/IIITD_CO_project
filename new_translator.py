import reader
from functions import dec_to_bin, gen_address,decimal_to_ieee
...
for i in range(len(input_list)):
    ...
    if input_list[i][0].count(":"):
        ...
        if input_list[i][1] == 'add':
        ...
        elif input_list[i][1] == "addf":
            machinecode[i].append(ISA['addf'])
            machinecode[i].append("00")
            machinecode[i].append(regs[input_list[i][2]])
            machinecode[i].append((regs[input_list[i][3]]))
            machinecode[i].append((regs[input_list[i][4]]))
            ...
            machinecode[i].append((regs[input_list[i][3]]))
            machinecode[i].append((regs[input_list[i][4]]))
        elif input_list[i][1] == "subf":
            machinecode[i].append(ISA['subf'])
            machinecode[i].append("00")
            machinecode[i].append(regs[input_list[i][2]])
            machinecode[i].append((regs[input_list[i][3]]))
            machinecode[i].append((regs[input_list[i][4]]))
        elif input_list[i][1] == "movf":
            machinecode[i].append(ISA['movf'])
            machinecode[i].append(regs[input_list[i][2]])
            machinecode[i].append(decimal_to_ieee(input_list[i][3]))
...
for i in range(len(input_list)): 
    if input_list[i][0] == 'var':
        ...
        machinecode[i].append(ISA['hlt'])    
        machinecode[i].append("00000000000")
    elif input_list[i][0] == "addf":
        machinecode[i].append(ISA['addf'])
        machinecode[i].append("00")
        machinecode[i].append(regs[input_list[i][1]])
        machinecode[i].append((regs[input_list[i][2]]))
        machinecode[i].append((regs[input_list[i][3]]))
    elif input_list[i][0] == "subf":
        machinecode[i].append(ISA['subf'])
        machinecode[i].append("00")
        machinecode[i].append(regs[input_list[i][1]])
        machinecode[i].append((regs[input_list[i][2]]))
        machinecode[i].append((regs[input_list[i][3]]))
    elif input_list[i][0] == "movf":
        machinecode[i].append(ISA['movf'])
        machinecode[i].append(regs[input_list[i][1]])
        machinecode[i].append(decimal_to_ieee(input_list[i][2]))        
